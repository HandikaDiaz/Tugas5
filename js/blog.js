...
//                             <div> ${dataBlog[index].start} - ${dataBlog[index].end}</div>
//                             <div></div>
...
function addBlog(event) {
  ...
  let checkRobot = document.getElementById("check-robot").checked
      ? robot
      : "";
  let checkSword = document.getElementById("check-sword").checked
      ? sword
      : "";
  let checkGun = document.getElementById("check-gun").checked
      ? gun
      : "";
  let checkFruit = document.getElementById("check-fruit").checked
      ? fruit
      : "";
